...
If `validation-log.md` already exists in the working directory, resume from the latest completed step. Otherwise, start with Step 0 (`framework-selection`) to pick the validation method, then Step 1.
