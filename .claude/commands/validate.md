---
description: Start (or resume) the 7-step idea validation workflow for an indie hacker product idea — no code required.
---
...
- Refuse to write product code until the Step 7 verdict is **GO**.
- Use `customer-interviews` whenever talking to real users (Step 1, 5, 6).
